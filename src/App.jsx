        ...
        <header className="mb-8 text-center sm:text-left sm:flex sm:items-center sm:justify-between border-b border-slate-200 pb-6">
          <div>
            ...
            <p className="mt-1 text-slate-500">
              Organize your daily workflows, priorities, and deadlines
              efficiently.
            </p>
          </div>
            ...
            <div className="space-y-3">
              {filteredTodos.length === 0 ? (
                ...
                filteredTodos.map((todo) => {
                  ...
                  const priorityStyle =
                    PRIORITIES[todo.priority] || PRIORITIES.Low;
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <div className="flex flex-wrap gap-2 items-center mt-2.5 text-xs">
                              {/* Priority Tag */}
                              <span
                                className={`px-2 py-0.5 rounded-full font-semibold border ${priorityStyle.color}`}
                              >
                                {todo.priority}
                              </span>
